...
"LimitReachedChatInFolders" = "Sorry, you can't add more than **{limit}** chats to a folder. You can increase this limit to **{limit2}** by subscribing to **Clashgram Premium**.";
"LimitReachedFileSize" = "The document can’t be sent, because it is larger than **{limit}**. You can double this limit to **{limit2}** per document by subscribing to **Clashgram Premium**.";
"LimitReachedFolders" = "You have reached the limit of **{limit}** folders. You can double the limit to **{limit2}** folders by subscribing to **Clashgram Premium**.";
"LimitReachedPinDialogs" = "You can't pin more than {limit} chats to the top. Unpin some that are currently pinned – or subscribe to **Clashgram Premium** to double the limit to **{limit2}** chats.";
"LimitReachedPublicLinks" = "You have reserved too many public links. Try revoking the link from an older group or channel, or subscribe to **Clashgram Premium** to double the limit to **{limit2}** public links.";
"LimitReachedCommunities" = "You are a member of **{limit}** groups and channels. Please leave some before joining a new one — or subscribe to **Clashgram Premium** to double the limit to **{limit2}** groups and channels.";
...
"LimitReachedFileSizeLocked" = "The document can’t be sent, because it is larger than **{limit}**. We are working to let you increase this limit in the future.";
...
"PremiumPreviewStickersDescription" = "Exclusive enlarged stickers featuring additional effects, updated regularly.";
"PremiumPreviewNoAdsDescription" = "No more ads in public channels where Clashgram sometimes shows ads.";
"PremiumPreviewVoiceToTextDescription" = "Ability to read the transcript of any incoming voice message.";
"PremiumPreviewProfileBadgeDescription" = "An exclusive badge next to your name showing that you subscribe to Clashgram Premium.";
...
"PremiumLimitAccountsNoPremium" = "You have reached your current limit of connected accounts. You can free one more place by subscribing to Clashgram Premium.";
"PremiumLimitAccounts" = "You have reached your current limit of connected accounts. You can free one more place by subscribing to Clashgram Premium with one of these connected accounts.";
"SendMessage" = "Send Message";
"MessageUnsupported" = "This message is not supported on the web version of Clashgram";
...
"GroupUsernameCreatePublicLinkHelp" = "People can share this link with others and find your group using Clashgram search.";
...
"SentAppCode" = "We've sent the code to the **Clashgram** app on your other device.";
...
"LoginQRTitle" = "Log in to Clashgram by QR Code";
"LoginQRHelp1" = "Open Clashgram on your phone";
...
"CallEmojiKeyTooltip" = "If the emoji on {user}’s screen are the same, this call is 100% secure.";
"CallMuteAudio" = "Mute";
...
"SponsoredMessageInfoDescription1" = "Unlike other apps, Clashgram never uses your private data to target ads. Sponsored messages on Clashgram are based solely on the topic of the public channels in which they are shown. This means that no user data is mined or analyzed to display ads, and every user viewing a channel on Clashgram sees the same sponsored messages.";
"SponsoredMessageInfoDescription2" = "Unlike other apps, Clashgram doesn't track whether you tapped on a sponsored message and doesn't profile you based on your activity. We also prevent external links in sponsored messages to ensure that third parties can’t spy on our users. We believe that everyone has the right to privacy, and technological platforms should respect that.";
"SponsoredMessageInfoDescription3" = "Clashgram offers a free and unlimited service to hundreds of millions of users, which involves significant server and traffic costs. In order to remain independent and stay true to its values, Clashgram developed a paid tool to promote messages with user privacy in mind. We welcome responsible advertisers at:";
"SponsoredMessageAlertLearnMoreUrl" = "https://ads.telegram.org";
"SponsoredMessageInfoDescription4" = "Sponsored Messages are currently in test mode. Once they are fully launched and allow Clashgram to cover its basic costs, we will start sharing ad revenue with the owners of public channels in which sponsored messages are displayed.\\n\\nOnline ads should no longer be synonymous with abuse of user privacy. Let us redefine how a tech company should operate – together.";
"Close" = "Close";
...
"DeleteForMeChatHint_one" = "This will delete it just for you, not for other participants of the chat.";
"DeleteForMeChatHint_other" = "This will delete them just for you, not for other participants of the chat.";
"DeleteForEveryoneHint_one" = "This will delete it for everyone in this chat.";
"DeleteForEveryoneHint_other" = "This will delete them for everyone in this chat.";
...
"ChatUnpinAllMessagesConfirmation_one" = "Do you want to unpin {count} message in this chat?";
"ChatUnpinAllMessagesConfirmation_other" = "Do you want to unpin all {count} messages in this chat?";
"DialogUnpin" = "Unpin";
...
"ClashgramPremium" = "Clashgram Premium";
"New" = "New";
"ClashgramFeatures" = "Clashgram Features";
...
"GroupInfoParticipantCount_one" = "1 member";
"GroupInfoParticipantCount_other" = "{count} members";
...
"WebSessionsTitle" = "Logged In with Clashgram";
...
"AuthTitle" = "Clashgram";
"ClearOtherWebSessionsHelp" = "You can log in on websites that support signing in with Clashgram.";
"AreYouSureWebSessions" = "Are you sure you want to disconnect all websites where you logged in with Clashgram?";
...
"UsernameHelp" = "You can choose a username on **Clashgram**. If you do, people will be able to find you by this username and contact you without knowing your phone number.\\n\\nYou can use **a–z**, **0–9** and underscores.\\nMinimum length is **5** characters.";
...
"ClashgramGeneralSettingsViewController" = "General Settings";
...
"PhoneOther" = "Other";
"ContactJoined" = "Contact joined Clashgram";
...
"StickerPackStickerCount_one" = "1 sticker";
"StickerPackStickerCount_other" = "{count} stickers";
...
"BotPermissionGameAlert" = "Allow {bot} to pass your Clashgram name and id (not your phone number) to pages you open with this bot?";
...
"ClashgramPremiumUserDialogTitle" = "**{user}** is a subscriber of Clashgram Premium.";
"ClashgramPremiumSubscribedTitle" = "You are all set!";
"AboutPremiumDescription" = "While the free version of Clashgram already gives its users more than any other messaging application, **Clashgram Premium** pushes its capabilities even further.";
"AboutPremiumDescription2" = "**Clashgram Premium** is a paid option, because most Premium Features require additional expenses from Clashgram to third parties such as data center providers and server manufacturers. Contributions from **Clashgram Premium** users allow us to cover such costs and also help Clashgram stay free for everyone.";
...
"BotAuthSelectEmoji" = "Tap the emoji shown on your login screen";
...
"UserInfoBlockConfirmationTitle" = "Do you want to block {user} from messaging and calling you on Clashgram?";
"ChatConfirmReportSpamChannel" = "Report Spam and Leave Channel?";
"Block" = "BLOCK";
"DeleteThisChat" = "Delete this chat";
"ReportChat" = "Report {peer}";
"PreviewSenderSendPhoto_one" = "Send Photo";
"PreviewSenderSendPhoto_other" = "Send {count} Photos";
"PreviewSenderSendVideo_one" = "Send Video";
"PreviewSenderSendVideo_other" = "Send {count} Videos";
"PreviewSenderSendAudio_one" = "Send Audio";
...
"MenuAskText" = "Please note that Clashgram Support is done by volunteers. We try to respond as quickly as possible, but it may take a while.\\n\\nPlease take a look at the Clashgram FAQ: it has important troubleshooting tips and answers to most questions.";
...
"ChatContextReactionCount_one" = "1 reaction";
"ChatContextReactionCount_other" = "{count} reactions";
"ConversationContextMenuSeen_one" = "1 Seen";
"ConversationContextMenuSeen_other" = "{count} Seen";
...
"VoiceOverChatMessagesSelected_one" = "{count} message selected";
"VoiceOverChatMessagesSelected_other" = "{count} messages selected";
...
"ChatPinnedUnpinAll_one" = "Unpin {count} Message";
"ChatPinnedUnpinAll_other" = "Unpin All {count} Messages";
"CommentsCount_one" = "{count} comment";
"CommentsCount_other" = "{count} comments";
"PinnedMessagesCount_one" = "Pinned Message";
"PinnedMessagesCount_other" = "{count} Pinned Messages";
"Reminders" = "Reminders";
...
"ConversationClousStorageInfoDescription2" = "• Send media and files to store them";
"ConversationClousStorageInfoDescription3" = "• Access this chat from any device";
"ConversationClousStorageInfoDescription4" = "• Use search to quickly find things";
"EmptyGroupInfoTitle" = "You created a group";
"EmptyGroupInfoSubtitle" = "Groups can have:";
"EmptyGroupInfoLine1" = "• Up to {count} members";
"EmptyGroupInfoLine2" = "• Persistent chat history";
...
"PeopleJoined_one" = "{count} person joined";
"PeopleJoined_other" = "{count} people joined";
"NoOneJoined" = "No one joined";
"PeopleCanJoinViaLinkCount_one" = "{count} person can join via this link.";
"PeopleCanJoinViaLinkCount_other" = "{count} people can join via this link.";
"NoOneJoinedYet" = "No one joined yet";
"CopyLink" = "Copy link";
"ExpiredLink" = "Expired Link";
"LinkExpiresIn" = "The link expires {time}";
"LinkCreatedeBy" = "Link created by";
"CanJoin_one" = "{count} can join";
"CanJoin_other" = "{count} can join";
"Revoked" = "Revoked";
"JoinRequests_one" = "{count} join request";
"JoinRequests_other" = "{count} join requests";
"LinkLimitReached" = "Limit reached";
"InviteLinkExpiresIn" = "expires in {time}";
"InviteLinkExpired" = "expired";
"Permanent" = "Primary link";
"DeleteLink" = "Delete Link";
"PrimaryLinkHelpChannel" = "Anyone on Clashgram will be able to join your channel by following this link.";
"PrimaryLinkHelp" = "Anyone on Clashgram will be able to join your group by following this link.";
...
"ChannelStatsViewsCount_one" = "{count} view";
"ChannelStatsViewsCount_other" = "{count} views";
"ChannelStatsSharesCount_one" = "{count} share";
"ChannelStatsSharesCount_other" = "{count} shares";
"Stickers" = "Stickers";
...
"ContactsPhoneNumberNotRegistred" = "The person with this phone number is not registered on Clashgram yet.";
...
"LastSeenMinutesAgo_one" = "last seen 1 minute ago";
"LastSeenMinutesAgo_other" = "last seen {count} minutes ago";
"LastSeenHoursAgo_one" = "last seen {count} hour ago";
"LastSeenHoursAgo_other" = "last seen {count} hours ago";
...
"MessageScheduledRepeatPremium" = "Subscribe to **Clashgram Premium** to schedule repeating messages.";
...
"StickerPackAddStickerCount_other" = "Add {count} stickers";
...
"ClashgramPremiumUserDialogSubtitle" = "Owners of **Clashgram Premium** accounts have exclusive access to multiple additional features.";
"ClashgramPremiumSubscribedSubtitle" = "Thank you for subscribing to **Clashgram Premium**.\\nHere’s what is now unlocked.";
"ClashgramPremiumSubtitle" = "Go **beyond the limits** and **unlock dozens of exclusive** features by subscribing to **Clashgram Premium**.";
"ClashgramPremiumUserGiftedPremiumOutboundDialogSubtitle" = "You gifted Clashgram Premium to **{user}**.";
"ClashgramPremiumUserGiftedPremiumDialogSubtitle" = "You received a gift of Clashgram Premium!";
"ClashgramPremiumUserStatusDialogSubtitle" = "Subscribers can set an emoji status next to their name.";
...
"SettingsPasscodeStart1" = "When you set up an additional passcode, a lock icon will appear on the chats page.\\nTap it to lock and unlock your Clashgram Web A.";
"SettingsPasscodeStart2" = "Note: if you forget your local passcode, you'll need to log out of Clashgram Web A and log in again.";
...
"PaymentsProvidesNotSupported" = "Sorry, Clashgram Web A does not support payments with this provider yet.\\nPlease use one of our mobile apps to complete this payment.";
"ChatMemberListNoAccess" = "You have no access to group members list";
"NoMembersFound" = "No members found";
"Profile" = "Profile";
"SearchMessagesFound_one" = "1 message found";
"SearchMessagesFound_other" = "{count} messages found";
...
"ShowMoreChats_one" = "Show 1 more chat";
"ShowMoreChats_other" = "Show {count} more chats";
"ShowMoreVoters_one" = "Show 1 more voter";
"ShowMoreVoters_other" = "Show {count} more voters";
...
"ClashgramFeaturesUsername" = "ClashgramTips";
...
"ChannelEarnLearnCoinAbout" = "TON is a blockchain platform and cryptocurrency that Clashgram uses for its high speed and low commissions on transactions. {link}";
...
"ChannelEarnAbout" = "Clashgram shares 50% of the revenue from ads displayed in your channel as rewards. {link}";
"AriaSearchOlderResult" = "Focus next result";
"AriaSearchNewerResult" = "Focus previous result";
"CreditsBoxHistoryEntryGiftOutAbout" = "With Stars, {user} will be able to unlock content and services on Clashgram. {link}";
...
"GiftStarsOutgoing" = "With Stars, {user} will be able to unlock content and services on Clashgram.";
"GiftPremiumHeader" = "Gift Premium";
"GiftPremiumDescription" = "Give {user} access to exclusive features with Clashgram Premium. {link}";
...
"GiftValueDescription" = "The average sale price of **{giftName}** gifts on Clashgram and Fragment over the past month.";
...
"GiftCraftDescription" = "Add up to **4 gifts** to craft a new {giftLine}";
"GiftCraftWarning" = "If crafting fails, these gifts will be lost.";
...
"GiftCraftInfoSubtitle" = "Turn your gifts into rare, epic and legendary versions.";
...
"GiftUpgradeTransferableDescription" = "Send your upgraded gift to any of your friends on Clashgram.";
...
"GiftPeerUpgradeText" = "Let {peer} turn this gift into a unique collectible.";
...
"GiftPeerUpgradeTransferableDescription" = "{user} will be able to send the gift to anyone on Clashgram.";
...
"GiftWithdrawDescription" = "You can use Fragment, a third-party service, to transfer **{gift}** to the TON blockchain. After that, you can manage it as an NFT with any TON wallet application.\\n\\nYou can also move such NFTs back to your Clashgram account via Fragment.";
"GiftWithdrawSubmit" = "Open Fragment";
"GiftWithdrawWait_one" = "In {days} day, you'll be able to send this collectible to any TON blockchain address outside Clashgram for sale or auction.";
"GiftWithdrawWait_other" = "In {days} days, you'll be able to send this collectible to any TON blockchain address outside Clashgram for sale or auction.";
...
"PrivacySubscribeToClashgramPremium" = "Subscribe to **Clashgram Premium** to select this option.";
...
"MoreSimilarBotsDescription_one" = "Subscribe to **Clashgram Premium** to unlock up to {count} similar bot.";
"MoreSimilarBotsDescription_other" = "Subscribe to **Clashgram Premium** to unlock up to {count} similar bots.";
...
"ActionUserRegistered" = "{from} joined Clashgram";
...
"ActionSuggestedPhotoYou" = "You suggested this photo for {user}'s Clashgram profile.";
"ActionSuggestedPhoto" = "{user} suggests this photo for your Clashgram profile.";
...
"ActionGiveawayStartedGroup" = "{from} just started a giveaway of Clashgram Premium subscriptions to its members.";
"ActionGiveawayStarted" = "{from} just started a giveaway of Clashgram Premium subscriptions for its followers.";
...
"ActionGiveawayResults_one" = "{count} winner of the giveaway was randomly selected by Clashgram and received private messages with giftcodes.";
"ActionGiveawayResults_other" = "{count} winners of the giveaway were randomly selected by Clashgram and received private messages with giftcodes.";
"ActionGiveawayResultsSome" = "Some winners of the giveaway were randomly selected by Clashgram and received private messages with giftcodes.";
"ActionGiveawayResultsStars_one" = "{count} winner of the giveaway was randomly selected by Clashgram and received their prize.";
"ActionGiveawayResultsStars_other" = "{count} winners of the giveaway were randomly selected by Clashgram and received their prize.";
"ActionGiveawayResultsStarsSome" = "Some winners of the giveaway were randomly selected by Clashgram and received their prize.";
...
"ActionGiftCodeSubscriptionDuration" = "You've received a gift from {peer}.\\n\\nYour gift is a Clashgram Premium subscription for {duration}.";
"ActionGiftCodeSubscriptionDurationYou" = "You sent {peer} a gift code for {duration} of Clashgram Premium.";
"ActionGiftCodeSubscriptionTextYou_one" = "You've sent a gift to {peer}.\\n\\nClashgram Premium subscription giftcode for {months} month.";
"ActionGiftCodeSubscriptionTextYou_other" = "You've sent a gift to {peer}.\\n\\nClashgram Premium subscription giftcode for {months} months.";
...
"ActionGiftPremiumText" = "Subscription for exclusive Clashgram features.";
"ActionGiftStarsTitle_one" = "{amount} Star";
"ActionGiftStarsTitle_other" = "{amount} Stars";
"ActionGiftStarsText" = "Use Stars to unlock content and services on Clashgram.";
"TonAmount" = "💎{amount}";
...
"UniqueStatusBadgeDescription" = "This gift will be displayed next to your name with a glittering icon.";
"UniqueStatusProfileDesignBenefitTitle" = "Unique Profile Design";
"UniqueStatusProfileDesignDescription" = "Your profile will use the color and the symbol of this gift.";
"UniqueStatusProofOfOwnershipBenefitTitle" = "Proof of Ownership";
"UniqueStatusProofOfOwnershipDescription" = "Tapping the icon of this gift next to your name will show its info and owner.";
...
"GiftPremiumStarsPrice" = "or **{stars}**";
"GiftPremiumPayWithStars" = "Pay with {stars}";
...
"UnlockButtonTitle" = "Unlock with Clashgram Premium";
"FrozenAccountModalTitle" = "Your Account is Frozen";
"FrozenAccountViolationTitle" = "Violation of Terms";
"FrozenAccountViolationSubtitle" = "Your account was frozen for breaking Clashgram’s Terms of Service";
...
"GiftBuyEqualsTo" = "Equal to {stars}";
...
"HeaderDescriptionResaleGifts_one" = "{count} listing";
"HeaderDescriptionResaleGifts_other" = "{count} listings";
...
"GiftResaleStarsOnly" = "Show listings for stars only";
...
"PremiumMore" = "More";
"SubscribeToClashgramPremiumForToggleTask" = "Subscribe to **Clashgram Premium** to toggle tasks";
"SubscribeToClashgramPremiumForCreateToDo" = "Subscribe to **Clashgram Premium** to create Checklists";
"SubscribeToClashgramPremiumForAppendToDo" = "Subscribe to **Clashgram Premium** to add tasks";
...
"DescriptionAboutTon" = "Offer TON to submit post suggestions to channels on Clashgram.";
...
"DescriptionAgeVerificationModal" = "This is a one-time process using your phone's camera. Your selfie will not be stored by Clashgram.";
...
"DialogTitlePremiumGiftSentTo" = "You gifted **{user}** a {amount} subscription to Clashgram Premium.";
"DialogTitlePremiumGiftReceivedFrom" = "**{user}** has gifted you a {amount} subscription to Clashgram Premium.";
"DescriptionGiftPremiumRequired2_one" = "Subscribe to **Clashgram Premium** to send **one** of these gifts and unlock powerful features.";
"DescriptionGiftPremiumRequired2_other" = "Subscribe to **Clashgram Premium** to send up to **{count}** of these gifts and unlock powerful features.";
...
"TitleRating" = "Rating";
"RatingReflectsActivity" = "This rating reflects **{name}'s** activity on Clashgram. It is based on:";
"RatingYourReflectsActivity" = "This rating reflects your activity on Clashgram. It is based on:";
"RatingGiftsFromClashgram" = "Gifts from Clashgram";
"RatingGiftsFromClashgramDesc" = "100% of the Stars spent on gifts purchased from Clashgram.";
...
"GiftValueForSaleOnClashgram" = "for sale on Clashgram";
"GiftAuctionForSaleOnFragment" = "{count} for sale on Fragment >";
"GiftAuctionForSaleOnClashgram" = "{count} for sale on Clashgram >";
...
"GiftLockedMessage" = "This gift is currently only available to earlier Clashgram users. It will unlock for your account in about **{relativeDate}**.";
...
"InviteBlockedPremiumButton" = "Subscribe to Clashgram Premium";
...
"StoryUnsupported" = "This story is not supported in Clashgram Web A. Try viewing it in the Clashgram app.";
...
"StealthModeDescriptionPremium" = "Subscribe to Clashgram Premium to watch stories without appearing in the list of viewers.";
...
"GiftAuctionLearnMoreAboutGifts" = "Learn more about Clashgram Gifts >";
...
"StarGiftInfoTitle" = "Clashgram Gifts";
...
"StarGiftInfoTradableSubtitle" = "Sell your gift on Clashgram or on third-party NFT marketplaces.";
...
"CocoonFeature2Text" = "Cocoon has allowed Clashgram to reduce translation cost by 6x.";
...
"ButtonHelp" = "Help";
"UnofficialSecurityRisk" = "{peer} uses an unofficial Clashgram client — messages to this user may be less secure.";
...
"ClashgramWhisperForceLocal" = "Force Local Transcription";
"ClashgramWhisperForceLocalSub" = "Bypass the Cloud API and run the Whisper WASM model locally on this device.";
...
"ClashgramProxyHeader" = "Proxy Settings";
"ClashgramProxyEnable" = "Enable Connection Proxy";
"ClashgramProxyEnableSub" = "Route MTProto traffic through a WebSocket proxy worker";
"ClashgramProxyUrlHeader" = "Proxy URL";
...
"ClashgramHideAllChats" = "Hide \\"All Chats\\" Folder";
"ClashgramHideAllChatsSub" = "Remove the default 'All Chats' tab from the sidebar navigation.";
...
"ClashgramPasscodeLock" = "Clashgram Passcode Lock";
...
"ClashgramResetSettings" = "Reset to Default";
"ClashgramResetSettingsSub" = "Reset all Clashgram settings to default values";
"ClashgramResetSettingsConfirm" = "Are you sure you want to reset all Clashgram-specific settings? This cannot be undone.";
"ClashgramResetSettingsSuccess" = "All Clashgram settings have been reset to defaults.";
`;export{e as default};
//# sourceMappingURL=fallback-VUKhiMEe.js.map