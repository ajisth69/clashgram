...
export interface ActionPayloads {
  ...
  openLocalTranscribeModal: WithTabId | undefined;
  closeLocalTranscribeModal: WithTabId | undefined;
  updateLocalTranscribeProgress: { progress: number } & WithTabId;
  ...
  openClashgramPasscodeModal: {
    type: 'chat' | 'folder';
    targetId: string | number;
    pendingAction: { type: 'openChat' | 'setActiveChatFolder' | 'clashgramUnlockChat' | 'clashgramUnlockFolder'; payload: any };
  } & WithTabId;
  closeClashgramPasscodeModal: WithTabId | undefined;
  openClashgramExportModal: { chatId: string } & WithTabId;
  closeClashgramExportModal: WithTabId | undefined;
}
