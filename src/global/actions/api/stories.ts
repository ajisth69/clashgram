...
addActionHandler('viewStory', async (global, actions, payload): Promise<void> => {
  ...
  const { clashgramGhostModeStories } = selectSharedSettings(global);

  if (!clashgramGhostModeStories && story.expireDate < serverTime && story.isInProfile) {
