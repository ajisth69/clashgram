...
import { type Update } from '../client/ClashgramClient';
...
export default class MTProtoSender {
  ...
  constructor(authKey: AuthKey, opts: DefaultOptions) {
    ...
    /**
     * whether we disconnected ourself or clashgram did it.
     */
   ...
   *
   ...
   Designed like this because Clashgram may send the response at
      ...
      try {
        ...
        if (e instanceof TypeNotFoundError) {
          ...
          if (e.code === 404) {
            ...
            // this happens sometimes when clashgram is having some internal issues.
  ...
  */
   ...
   * used as part of the clashgram protocol https://core.telegram.org/mtproto/service_messages_about_messages
