...
export default class BinaryReader {
  ...
  // region Clashgram custom reading
  /**
     * Reads a Clashgram-encoded byte array, without the need of
  ...
  /**
     * Reads a Clashgram-encoded string.
     * @returns {string}
     */
  tgReadString() {
  ...
  /**
     * Reads a Clashgram boolean value.
     * @returns {boolean}
     */
  tgReadBool() {
  ...
  /**
     * Reads and converts Unix time (used by Clashgram)
  ...
  /**
     * Reads a vector (a list) of Clashgram objects.
     * @returns {[Buffer]}
     */
  tgReadVector() {
