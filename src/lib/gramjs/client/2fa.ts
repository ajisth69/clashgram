 ...
 * @param client: The clashgram client instance
 ...
 * @param hint: Hint to be displayed by Clashgram when it asks for 2FA.
...
export async function getTmpPassword(client: ClashgramClient, currentPassword: string, ttl = 60) {
  const pwd = await client.invoke(new Api.account.GetPassword());
