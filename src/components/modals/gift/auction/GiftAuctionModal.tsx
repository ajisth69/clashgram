...
const GiftAuctionModal = ({ modal, auctionState }: OwnProps & StateProps) => {
  ...
  const modalData = useMemo(() => {
    ...
    const canBuyOnClashgram = state.type === 'finished' && Boolean(state.listedCount);
    ...
    const footer = (
      <div className={styles.footer}>
        ...
        {canBuyOnClashgram && (
          <Link className={styles.itemsBoughtLink} isPrimary onClick={handleOpenClashgramMarket}>
            {lang('GiftAuctionForSaleOnClashgram', {
              count: giftSticker ? (
                <>
    ...
    handleOpenFragment, handleOpenClashgramMarket]);
