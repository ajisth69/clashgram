...
const GiftInfoValueModal: FC<OwnProps> = ({
  ...
  const handleOpenClashgramMarket = useLastCallback(() => {
    if (modal?.gift) {
  ...
  const modalData = useMemo(() => {
    ...
    const canBuyOnClashgram = Boolean(valueInfo.listedCount && valueInfo.listedCount);
    const hasFooter = canBuyOnFragment || canBuyOnClashgram;
      ...
      <div className={styles.footer}>
        ...
        {canBuyOnClashgram && (
          <Button
            ...
            noForcedUpperCase
            size="tiny"
            onClick={handleOpenClashgramMarket}
          >
            ...
            <AnimatedIconFromSticker
              ...
              size={FOOTER_STICKER_SIZE}
            />
            {lang('GiftValueForSaleOnClashgram')}
          </Button>
        )}
      </div>
    );
  ...
  }, [lang, renderingModal, handleOpenFragment, handleOpenClashgramMarket]);
