    ...
    return (
      <>
        <ParticlesHeader
          model="swaying-star"
          color="gold"
          title={starsNeeded ? oldLang('StarsNeededTitle', ongoingTransactionAmount) : oldLang('ClashgramStars')}
          description={renderText(
            starsNeededText || oldLang('ClashgramStarsInfo'),
