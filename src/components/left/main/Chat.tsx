    ...
    >
      ...
      <div className={buildClassName('info', isTagsMode && 'has-tags')}>
        <div className="info-row">
          ...
          />
          {!isUserId(chatId) && chat.isCreator && (
            <span className="clashgram-badge owner">Owner</span>
          )}
          {!isUserId(chatId) && !chat.isCreator && chat.adminRights && (
            <span className="clashgram-badge admin">Admin</span>
          )}
