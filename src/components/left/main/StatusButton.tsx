...
const StatusButton = ({ emojiStatus, collectibleStatuses, isAccountFrozen }: StateProps) => {
  const {
    setEmojiStatus, loadCurrentUser, openFrozenAccountModal, openLeftColumnContent, openSettingsScreen,
  } = getActions();
  ...
  const handleEmojiStatusClick = useCallback(() => {
    ...
    openStatusPicker();
  }, [openStatusPicker, isAccountFrozen, emojiStatus, openLeftColumnContent, openSettingsScreen]);
