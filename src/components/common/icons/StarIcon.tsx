...
import PremiumStarSvg from '../../../assets/premium/PremiumStar.svg';
...
function PremiumStarIcon() {
  return (
    <img src={PremiumStarSvg} className={styles.img} alt="" />
  );
}
