...
type OwnProps = {
  ...
  onSearchByUser?: NoneToVoidFunction;
...
const MessageContextMenu: FC<OwnProps> = ({
  ...
  const handleMarkAsOpened = useLastCallback(() => {
    getActions().markMessagesRead({ chatId: message.chatId, messageIds: [message.id] });
    onClose();
  });
  ...
  return (
    ...
    >
      ...
      >
        ...
        {!message.isOutgoing && hasMessageTtl(message) && message.isMediaUnread && (
          <MenuItem icon="check" onClick={handleMarkAsOpened}>
            Mark as Opened
          </MenuItem>
        )}
        ...
        {canSearchByUser && (
          <MenuItem icon="search" onClick={onSearchByUser}>
