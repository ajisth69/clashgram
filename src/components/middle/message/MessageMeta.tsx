  ...
  return (
    ...
    >
      ...
      <span className="message-time" title={dateTitle} onMouseEnter={markActivated}>
        {message.content?.ttlSeconds !== undefined && (
          <span className="message-ttl" style="margin-right: 6px; opacity: 0.9; font-weight: bold; color: #ff5c5c;">
            🔥 {message.content.ttlSeconds === 2147483647 ? 'View Once' : `${message.content.ttlSeconds}s`}
          </span>
        )}
