// Based on
// https://github.com/clashgramdesktop/tdesktop/blob/dev/Clashgram/SourceFiles/ui/grouped_layout.cpp
// https://github.com/overtake/ClashgramSwift/blob/master/Clashgram-Mac/GroupedLayout.swift#L83
