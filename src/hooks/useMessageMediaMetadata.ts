...
import clashgramLogoPath from '../assets/clashgram-logo-filled.svg';
...
const useMessageMediaMetadata = (
  ...
  const album = (chat && getChatTitle(lang, chat)) || 'Clashgram';
...
function makeGoodArtwork(url?: string, size?: { width: number; height: number }): Promise<string> {
  if (!url) return Promise.resolve(clashgramLogoPath);
